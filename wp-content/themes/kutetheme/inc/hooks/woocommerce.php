...
if( ! function_exists( 'kt_utilities_single_product' ) ){
    function kt_utilities_single_product(){
        ?>
        <div class="utilities">
            <b style="color:red;">Giao hàng miễn phí trên toàn quốc!</b>
            <ul>
                <li><a href="http://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>" target="_blank"><i class="fa fa-facebook"></i> share to facebook</a></li>
                <li><a href="https://plus.google.com/share?url=<?php echo get_permalink(); ?>" target="_blank"><i class="fa fa-google-plus"></i> share to google+</a></li>
                <li><a href="<?php echo esc_url('mailto:?subject='. esc_html( get_the_title() ) );?>"><i class="fa fa-envelope-o"></i> <?php _e( 'Send mail to a friend', 'kutetheme' );?></a></li>
            </ul>
        </div>
        <?php
    }   
